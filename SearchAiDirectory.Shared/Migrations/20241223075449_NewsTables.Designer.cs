...
namespace SearchAiDirectory.Shared.Migrations
{
    ...
    [Migration("20241223075449_NewsTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SearchAiDirectory.Shared.Models.News", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SearchAiDirectory.Shared.Models.NewsEmbedding", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SearchAiDirectory.Shared.Models.NewsEmbedding", b =>
                {
                    b.HasOne("SearchAiDirectory.Shared.Models.News", "News")
                        .WithOne("Embedding")
                        .HasForeignKey("SearchAiDirectory.Shared.Models.NewsEmbedding", "NewsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
